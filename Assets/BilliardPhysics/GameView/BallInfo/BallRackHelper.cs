...
{
    // ===== 桌参数（mm / 100）=====
    public const float TableLength = 25.4f;
    public const float TableWidth  = 12.7f;

    const float BallDiameter = 0.5715f;
    const float Gap = 0.0005f; // 避免初始重叠（原始值 0.05 mm，缩小100倍：5e-4）
